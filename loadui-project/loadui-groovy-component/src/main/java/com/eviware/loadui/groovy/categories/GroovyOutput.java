...
public class GroovyOutput extends OutputBase
{
	...
	public GroovyOutput( GroovyBehaviorProvider scriptUpdateFirer, ComponentContext context )
	{
		super( context );
	...
	{
		scriptSupport.getEnvironment().invokeClosure( false, false, "output", message );
	}
