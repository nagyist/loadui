...
import ThreadSafeClientConnManager
import ActionEvent
import PropertyEvent
import CanvasItem
import SampleCancelledException
import ActivityStrategies
import DelayedFormattedString
import ReleasableUtils

import java.util.concurrent.TimeUnit

import Scheme
import SSLSocketFactory
import java.net.URI
...
class HttpCustom extends HttpEntityEnclosingRequestBase {
  ...
  HttpCustom(method, uri) {
     HttpEntityEnclosingRequestBase.setURI(URI.create(uri))
     _method = method
  }
